...
<form class="mk-ajax-form">
	...
	<div class="avatar mk-mess" style="color: white">
		<div class="mk-mess-cont">
			<img src="<?php echo get_template_directory_uri(); ?>/images/icon-container.svg" alt="Icon">
			<div class="mk-mess-text">
			<p>Thank you for subscribing!</p>
			<p>
				We’ve sent you an email. If you don’t see it soon, be sure to check your spam folder.
			</p>
			</div>
			<img src="<?php echo get_template_directory_uri(); ?>/images/CloseButton.svg" alt="Icon" class="mk-mess-close">
		</div>
	</div>
